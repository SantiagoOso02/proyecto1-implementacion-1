...
public interface Operacion_Cuenta_TransferenciaRepository extends JpaRepository<Operacion_Cuenta_Transferencia, Integer>{
    ...
    Operacion_Cuenta_Transferencia darOperacion_Cuenta_Transferencia(@Param("ID") String ID);
    ...
    void actualizarOperacion_Cuenta_Transferencia (@Param("ID") String ID, @Param("monto") float monto, @Param("hora") Date hora, @Param("fecha") Date fecha, @Param("tipo") String tipo, @Param("numero_cuenta_origen") Cuenta numero_cuenta_origen, @Param("numero_cuenta_destino") Cuenta numero_cuenta_destino, @Param("tipo_doc_empleado") Empleado tipo_doc_empleado, @Param ("num_doc_empleado") Empleado num_doc_empelado, @Param("tipo_doc_cliente") Cliente tipo_doc_cliente, @Param("num_doc_cliente") Cliente num_doc_cliente, @Param("punto_atencion") Punto_Atencion punto_atencion);

    @Modifying
    @Transactional
    @Query(value = "DELETE FROM OPERACIONES_CUENTA_TRANSFERENCIA WHERE ID=:ID", nativeQuery = true)
    void eliminarOperacion_Cuenta_Transferencia (@Param("ID") String ID);
}